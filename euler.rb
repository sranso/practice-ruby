...
def letters_in_numbers
  one_to_nine = 3 + 3 + 5 + 4 + 4 + 3 + 5 + 5 + 4
  ten_to_nineteen = 3 + 6 + 6 + 8 + 8 + 7 + 7 + 9 + 8 + 8
  twenty_to_ninetynine = (6 + 6 + 5 + 5 + 5 + 7 + 6 + 6) * 10 + one_to_nine * 8
  under_onehundred = one_to_nine + ten_to_nineteen + twenty_to_ninetynine
  hundredand = 10 * 9 * 99
  onehundred_to_nineninetynine = one_to_nine * 99 + hundredand + ten_to_nineteen * 9 + twenty_to_ninetynine * 9
  thousand = 3 + 8
